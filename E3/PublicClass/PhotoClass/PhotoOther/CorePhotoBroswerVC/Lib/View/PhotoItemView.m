...
-(void)zoomDismiss:(void(^)())compeletionBlock{
    ...
    self.photoModel.currIndex = self.pageIndex;
    self.photoModel.sourceImageView.hidden = NO;
//    self.photoModel.sourceImageView = self.photoModel.sourceAllImageViews[self.pageIndex];
    self.photoModel.sourceImageView = self.photoModel.sourceAllImageViews[0];
    self.photoModel.sourceImageView.hidden = YES;
